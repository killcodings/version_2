...
<style>
    :root {
        ...
        --buttons-gradient-start: <?= $buttons_setup['gradient_colors']['start_color'] ?: '#EEE' ?>;
        --buttons-gradient-end: <?= $buttons_setup['gradient_colors']['end_color'] ?: '#CCC' ?>;
        --buttons-gradient-color: <?= $buttons_setup['gradient_colors']['color'] ?: '#FFF' ?>;
        --buttons-gradient-color-hover: <?= $buttons_setup['gradient_colors']['color_hover'] ?: '#FFF' ?>;
